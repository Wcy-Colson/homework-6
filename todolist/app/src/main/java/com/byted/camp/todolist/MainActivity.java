...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        try{
            cursor = db.query(TodoContract.TodoNote.TABLE_NAME,
                    new String[]{
                            TodoContract.TodoNote._ID,
                            TodoContract.TodoNote.CONTENT,
                            TodoContract.TodoNote.STATE,
                            TodoContract.TodoNote.DATE
                    },null,null,null,null,
                    TodoContract.TodoNote.DATE + " DESC");
    ...
    private void deleteNote(Note note) {
        ...
        int deleteRows = db.delete(TodoContract.TodoNote.TABLE_NAME,selection,selectionArgs);
        if(deleteRows>0){
            notesAdapter.refresh(loadNotesFromDatabase());
        }
    }
    ...
    private void updateNode(Note note) {
        ...
        int updateRows = db.update(TodoContract.TodoNote.TABLE_NAME,values,selection,selectionArgs);
        if(updateRows>0){
            notesAdapter.refresh(loadNotesFromDatabase());
        }
